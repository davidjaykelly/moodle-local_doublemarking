...
/**
 * Privacy provider implementation for local_doublemarking.
 *
...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        $collection->add_database_table(
            ...
            [
                ...
                'ratificationcomment' => 'privacy:metadata:local_doublemarking_alloc:ratificationcomment',
            ],
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
        ...
        // Find contexts where the user is a student, marker, or ratifier.
        $sql = "
            SELECT ctx.id
            FROM {
